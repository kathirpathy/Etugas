            ...
            <div class="container-fluid h-custom">
                ...
                <div class="demo-html">
                    ...
                    <?php
                        ...
                        // echo "<td><a href='edit.php?update && edit={$no_id}' button type='button' class='btn btn-warning'> 
                        // <i class='bi bi-pencil-square'> </i></button></td>";
                        echo "<td><a href='view_semakan.php?view={$no_id}' button type='button' class='btn btn-primary'>
                        <i class='bi bi-eye-fill'> </i></button>
                        <a href='delete_semakan.php?delete={$no_id}' button type='button' class='btn btn-danger'>
