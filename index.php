...
<body>
    ...
    <section id="banner">
    <div class="container">
        <marquee><h1><span class="highlight">SISTEM PELEPASAN TUGAS PENSYARAH ILPS</span></h1></marquee>
        <p>Sistem ini adalah satu alternatif baru bagi memudahkan pensyarah dan ketua jabatan mengisi dan mengesahkan borang pelepasan tugas pensyarah</p>
    </div>
    </section>
    </nav>
    ...
    <section id="boxes">
      <div class="container"> 
        <div class="box">
          ...
          <img src="img/admin.png"><h3>PENTADBIR</h3></a>
        </div>
        <div class="box">
          <a href="login_pengajar.php">
            <img src="img/pengajar.jpg"><h3>PENSYARAH</h3></a>
        </div>
        <div class="box">
          <a href="login_ketuabahagian.php">
