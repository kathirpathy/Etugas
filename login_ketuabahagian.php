...
<body>
    ...
    <h2>Ketua Bahagian</h2>
    <form action="login_proses_ketuabahagian.php" method="post">
        <div class="imgcontainer">
            <img src="./img/kj.png" alt="Avatar" class="avatar">
        </div>
        ...
        <div class="container">
            ...
            <input type="password" placeholder="Masukkan Kata Laluan" name="password" value="Kata Laluan" required>
