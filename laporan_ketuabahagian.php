    ...
    <section class="vh-100">
        <div class="container-md">
            <div class="container-fluid h-custom">
                <h2>Laporan Kelulusan Permohonan</h2>
                ...
                <div class="demo-html">
                    ...
                    <!-- <a href="printpdf.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a> -->
                    <!-- <a href='printpdf.php' button type='button' class='btn btn-success pull-right'><i class='bi bi-printer'></i> Cetak Laporan<a/></button> -->
                    <br><br>
                        <tr>
                            <th>Bil</th>
                            <th>ID Pegawai</th>
                    ...
                    <?php
                        ...
                        // echo "<td><a href='printpdf1.php?print={$no_id}' button type='button' class='btn btn-success pull-right'><i class='bi bi-printer'></i> Cetak <a/></td>";
                        // echo "<td><button type='button' class='btn btn-warning'><a href='edit_kelulusan.php? update && edit={$no_id}'> 
                        ...
                        // echo "<td><a href='printpdf.php' class='btn btn-success pull-right'><span class='glyphicon glyphicon-print'></span> PDF</a></td>";
                        // echo "<td>$lulus_jabatan</td>";
                        echo "</tr>";
                        $i++;
                        }
