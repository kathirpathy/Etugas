...
<?php
    ...
    if (isset($_POST['btn_submit'])){
      ...
      $sql = "INSERT INTO tbl_ketuabahagian (id_pegawai, username, password, nama, emel, notel, alamat, jabatan, peranan) VALUES ('{$id_pegawai}','{$username}','{$password}','{$nama}','{$emel}','{$notel}','{$alamat}','{$jabatan}','{$peranan}')";
      ...
      else { echo "<script type'text/javascript'>alert('Daftar ketua bahagian telah berjaya!')</script>";
...
<body>
  ...
  <form class="form-horizontal" role="form" action="" method="post">
    ...
    <div class="form-outline mb-2">
      ...
      <div class="col-sm-10">
        <input type="password" class="form-control" id="password" placeholder="Masukkan katalaluan" name="password" required>
      </div>
    </div>
