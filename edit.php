...
{
    $id = $_GET['edit'];
        $query = "SELECT no_id, id_pegawai, username, password, nama, emel, notel, alamat, jabatan, peranan, tahapakses FROM tbl_daftar WHERE no_id={$id}";
    ...
    if(isset($_POST['update'])){
        {
            ...
            $sql = "UPDATE tbl_daftar SET id_pegawai = '{$id_pegawai}', username = '{$username}', nama ='{$nama}', emel = '{$emel}', notel = '{$notel}', alamat = '{$alamat}', jabatan = '{$jabatan}', peranan = '{$peranan}' WHERE no_id ={$no_id}";
            ...
            if(!$update){
                ...
                else{ echo "<script type'text/javascript'>alert('Data pengajar berjaya diubah!')</script>";
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item active">
                <a class="nav-link" href="maklumat_pengajar.php">Pentadbir</a>
            </li>
        </ul>
      </div>
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <div class="page-wrapper">
        <div class="row page-titles">
                <div class="col-md-8 align-self-center">
                    <center><h3 class="text-primary">Kemaskini Maklumat <u><?php echo $nama ?></u></h3></center></div>
                </div>
                                        ...
                                        <label class="col-sm-3 control-label">Jabatan</label>
                                            <div class="col-sm-9">
                                                ...
                                                <option selected><?php echo $jabatan?></option>
                                                    <option name="jabatan" value="Teknologi Komputer Perisian (Pengaturcaraan) ">Teknologi Komputer Perisian (Pengaturcaraan)</option>
                                                    ...
                                                    <option name="jabatan" value="Teknologi Minyak & Gas (Lukisan Perpaipan) ">Teknologi Minyak & Gas (Lukisan Perpaipan)</option>
